    ...
    if (descriptor.attributeChangedCallback) {
        for (var attributeName in descriptor.observedAttributeMap) {
            ...
            if (attributeValue !== null) {
                descriptor.attributeChangedCallback.call(el, attributeName, attributeValue, null);
            }
        }
    }
 ...
 */
Hook.prototype.forceNotifyAttributeChange = function (descriptor, el, attributeName, attributeValue, oldValue) {
    if (descriptor.attributeChangedCallback && (attributeName in descriptor.observedAttributeMap)) {
        descriptor.attributeChangedCallback.call(el, attributeName, attributeValue, oldValue);
    }
};
